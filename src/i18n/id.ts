const id = {
    ...
    sidebar: {
        ...
        floodPredict: 'Prediksi Banjir',
        visualVerify: 'Verifikasi Visual',
        cctvSimulation: 'Simulasi CCTV',
    ...
    floodAlert: {
        ...
        hours: 'jam',
        noActiveAlerts: 'Tidak ada peringatan aktif saat ini'
    },
    floodReport: {
        rising: 'Naik',
        falling: 'Turun',
    ...
    commandMenu: {
        ...
        suggestions: 'Saran Lokasi'
    },
    alerts: {
        back: 'Kembali',
        latestFloodNews: 'Berita Banjir Terkini',
        articles: 'artikel',
        minutesAgo: 'm lalu',
        hoursAgo: 'j lalu'
    },
    floodPredict: {
        title: 'Prediksi Banjir (LSTM)',
        subtitle: 'Prediksi ketinggian air berbasis curah hujan',
        inputData: 'Input Data',
        autoLive: 'Auto (Live)',
        manual: 'Manual',
        demoScenario: 'Demo Skenario',
        autoMode: 'Mode Auto Predict',
        autoDesc: 'Mengambil data ketinggian air live (historical replay dari Manggarai) dan curah hujan real-time dari OpenWeatherMap untuk Bogor & Jakarta, lalu diproses oleh model LSTM.',
        dataUsed: 'Data yang Digunakan:',
        waterLevel: 'Tinggi Air',
        rainfallBogor: 'Curah Hujan Bogor',
        rainfallJakarta: 'Curah Hujan Jakarta',
        scenario: 'Skenario',
        selectScenario: 'Pilih skenario',
        currentWaterLevel: 'Tinggi Air Saat Ini',
        predicting: 'Memprediksi...',
        autoPredictBtn: 'Auto Predict (Data Live)',
        getPrediction: 'Dapatkan Prediksi',
        result: 'Hasil Prediksi',
        manualInput: 'Input Manual',
        predictedWaterLevel: 'Prediksi Tinggi Air',
        riskLevel: 'Tingkat Risiko',
        recommendation: 'Rekomendasi',
        autoEmptyState: 'Klik "Auto Predict" untuk mengambil data live dan menjalankan model LSTM.',
        manualEmptyState: 'Masukkan data dan klik "Dapatkan Prediksi" untuk melihat hasil.',
        ready: 'Siap',
        offline: 'Offline'
    },
    visualVerify: {
        title: 'Verifikasi Visual (YOLO)',
        subtitle: 'Unggah gambar untuk mendeteksi banjir',
        uploadImage: 'Unggah Gambar',
        dragDrop: 'Seret dan lepas atau klik untuk memilih',
        analyzing: 'Menganalisis...',
        verify: 'Verifikasi',
        reset: 'Reset',
        detectionResult: 'Hasil Deteksi',
        floodDetected: 'Banjir terdeteksi',
        noFlood: 'Tidak ada banjir terdeteksi',
        floodProbability: 'Probabilitas banjir',
        objectsDetected: 'Objek terdeteksi',
        emptyState: 'Unggah gambar dan klik Verifikasi untuk menganalisis.'
    },
    cctvSimulation: {
        title: 'Monitoring CCTV',
        subtitle: 'Deteksi banjir multi-channel YOLOv8',
        floodDetected: 'Banjir Terdeteksi',
        normal: 'Normal',
        offline: 'Offline',
        floodBadge: 'BANJIR TERDETEKSI',
        normalBadge: 'NORMAL',
        offlineBadge: 'OFFLINE',
        confidence: 'Confidence',
        objectsDetected: 'Objek Terdeteksi',
        none: 'Tidak ada',
        lastScan: 'Terakhir Scan',
        justNow: 'Baru saja',
        minutesAgo: 'menit yang lalu',
        unavailable: 'Tidak tersedia',
        floodProbability: 'Probabilitas Banjir',
        systemInfo: 'Informasi Sistem CCTV'
    },
    smsSubscribe: {
        title: 'SMS Peringatan Banjir',
        subtitle: 'Terima peringatan langsung ke HP Anda',
        whySms: 'Mengapa SMS?',
        whySmsDesc: 'SMS bekerja di semua jenis HP — tidak perlu smartphone atau internet. Cocok untuk daerah pedesaan dan komunitas yang belum terjangkau internet cepat. Peringatan dikirim otomatis saat AI mendeteksi risiko banjir.',
        allPhones: 'Semua HP',
        noInternet: 'Tanpa Internet',
        autoAi: 'Otomatis AI',
        registered: 'Berhasil Terdaftar!',
        registerAnother: 'Daftar Nomor Lain',
        backToDashboard: 'Kembali ke Dashboard',
        formTitle: 'Daftar SMS Peringatan',
        formDesc: 'Masukkan data Anda untuk menerima peringatan banjir via SMS',
        phoneNumber: 'Nomor Telepon',
        nameOptional: 'Nama (opsional)',
        monitoringRegion: 'Wilayah Monitoring',
        smsLanguage: 'Bahasa SMS',
        smsPreview: 'Contoh SMS yang akan diterima:',
        registering: 'Mendaftar...',
        submitButton: 'Daftar Peringatan SMS',
        privacyNote: 'Nomor telepon Anda hanya digunakan untuk peringatan banjir dan tidak akan dibagikan ke pihak ketiga. Anda bisa berhenti kapan saja dengan membalas STOP.',
        howItWorks: 'Bagaimana Cara Kerjanya?',
        step1Title: '1. Daftar',
        step1Desc: 'Masukkan nomor HP dan pilih wilayah yang ingin dipantau',
        step2Title: '2. AI Memantau',
        step2Desc: 'LSTM & YOLO AI terus menganalisis data curah hujan dan ketinggian air',
        step3Title: '3. SMS Otomatis',
        step3Desc: 'Saat risiko tinggi terdeteksi, SMS peringatan langsung terkirim'
    },
    riskForecast: {
        title: 'Prakiraan Risiko',
        highestRisk: 'Risiko Tertinggi',
        now: 'Saat ini',
        formula: 'LSTM (50%) + Curah Hujan (30%) + CCTV (20%). Waktu menunjukkan estimasi kedatangan banjir kiriman.',
